...
After installing the above dependencies, install dsg-angular2-wizard via:

```bash
$ npm install dsg-angular2-wizard --save
```
...
// Import your library
import { FormWizardModule } from 'dsg-angular2-wizard';
